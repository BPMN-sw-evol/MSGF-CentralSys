...
public class TreasuryController {
    ...
    private final TreasuryServices treasuryServices;
    ...
    public String CreditCommitteView(Model model) throws IOException {
        ...
        for (String processId : processIds) {
            CreditRequestDTO creditRequestDTO = this.treasuryServices.getProcessVariablesById(processId);
    ...
    public String approveTaskCouple(@RequestParam(name = "processId") String processId){
        this.treasuryServices.approveTask(processId);
